...
This stage is described in the [`RELEASE.md`](../RELEASE.md) file of this repository.  
...
In the admin interface the release can be reviewed, approved, and published.  
...
The following states describe the lifecycle of a release within the portal admin interface.
