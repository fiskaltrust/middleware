...
namespace fiskaltrust.Middleware.Localization.QueueES.RequestCommands
{
    public class DailyClosingReceiptCommand : Contracts.RequestCommands.DailyClosingReceiptCommand
    {
        ...
        public DailyClosingReceiptCommand(ISSCD signingDevice, ILogger<DailyClosingReceiptCommand> logger, SignatureItemFactoryES signatureItemFactory, ICountrySpecificSettings countrySpecificSettings, IESSSCDProvider sscdProvider, IMiddlewareJournalITRepository journalITRepository)
        {
        ...
        protected override async Task<RequestCommandResponse> SpecializeAsync(RequestCommandResponse requestCommandResponse, ftQueue queue, ReceiptRequest request, ftQueueItem queueItem) => throw new NotImplementedException();
    }
}
