...
using fiskaltrust.Interface.Tagging.Models.V2.AT.Extensions;
using fiskaltrust.Interface.Tagging.Models.V2.Extensions;
using V2AT = fiskaltrust.Interface.Tagging.Models.V2;
using V2SignaturItemftSignatureTypeSignatureTypeExt = fiskaltrust.Interface.Tagging.Models.V2.Extensions.V2SignaturItemftSignatureTypeSignatureTypeExt;
...
namespace fiskaltrust.Interface.Tagging.AT
{
    public class CaseConverterAT : ICaseConverter
    {
        public void ConvertftChargeItemCaseToV1(ChargeItem chargeItem)
        {
            ...
            {
                chargeItem.ftChargeItemCase |=
                    (long)((V2.ftChargeItemCases)(v2ChargeItem.ftChargeItemCase & 0xFFFF) switch
                    {
                        V2.ftChargeItemCases.UnknownTypeOfService0x0000 => V1.AT.ftChargeItemCases
                            .UnknownTypeOfService0x0000,
                        V2.ftChargeItemCases.UndefinedTypeOfServiceNormalVATRate0x0003 => V1.AT.ftChargeItemCases
                            .UndefinedTypeOfServiceNormalVat0x0003,
                        V2.ftChargeItemCases.UndefinedTypeOfServiceDiscountedVATRate10x0001 => V1.AT.ftChargeItemCases
                            .UndefinedTypeOfServiceDiscounted1Vat0x0001,
                        V2.ftChargeItemCases.UndefinedTypeOfServiceDiscountedVATRate20x0002 => V1.AT.ftChargeItemCases
                            .UndefinedTypeOfServiceDiscounted2Vat0x0002,
                        V2.ftChargeItemCases.UndefinedTypeOfServiceSpecialVATRate10x0004 => V1.AT.ftChargeItemCases
                            .UndefinedTypeOfServiceSpecial1Vat0x0004,
                        V2.ftChargeItemCases.UndefinedTypeOfServiceZeroVAT0x0007 => V1.AT.ftChargeItemCases
                            .UndefinedTypeOfServiceZeroVat0x0005,
                        V2.ftChargeItemCases.ReverseChargeReversalOfTaxLiability0x5000 => V1.AT.ftChargeItemCases
                            .ReverseCharge0x0006,
                        V2.ftChargeItemCases.NotOwnSales0x0060 => V1.AT.ftChargeItemCases.NotOwnSales0x0007,
                        V2.ftChargeItemCases.DeliveryNormalVATRate0x0013 => V1.AT.ftChargeItemCases
                            .DeliveryNormalVat0x000A,
                        V2.ftChargeItemCases.DeliveryDiscountedVATRate10x0011 => V1.AT.ftChargeItemCases
                            .DeliveryDiscounted1Vat0x0008,
                        V2.ftChargeItemCases.DeliveryDiscountedVATRate20x0012 => V1.AT.ftChargeItemCases
                            .DeliveryDiscounted2Vat0x0009,
                        V2.ftChargeItemCases.DeliverySpecialVATRate10x0014 => V1.AT.ftChargeItemCases
                            .DeliverySpecial1Vat0x000B,
                        V2.ftChargeItemCases.DeliveryZeroVAT0x0017 => V1.AT.ftChargeItemCases.DeliveryZeroVat0x000C,
                        V2.ftChargeItemCases.OtherServicesNormalVATRate0x0023 => V1.AT.ftChargeItemCases
                            .OtherServicesNormalVat0x000F,
                        V2.ftChargeItemCases.OtherServicesDiscountedVATRate10x0021 => V1.AT.ftChargeItemCases
                            .OtherServicesDiscounted1Vat0x000D,
                        V2.ftChargeItemCases.OtherServicesDiscountedVATRate20x0022 => V1.AT.ftChargeItemCases
                            .OtherServicesDiscounted2Vat0x000E,
                        V2.ftChargeItemCases.OtherServicesSpecialVATRate10x0024 => V1.AT.ftChargeItemCases
                            .OtherServicesSpecial1Vat0x0010,
                        V2.ftChargeItemCases.OtherServicesZeroVAT0x0027 => V1.AT.ftChargeItemCases
                            .OtherServicesZeroVat0x0011,
                        V2.ftChargeItemCases.CatalogueServicesNormalVATRate0x0053 => V1.AT.ftChargeItemCases
                            .CatalogueServicesNormalVat0x0014,
                        V2.ftChargeItemCases.CatalogueServicesDiscountedVATRate10x0051 => V1.AT.ftChargeItemCases
                            .CatalogueServicesDiscounted1Vat0x0012,
                        V2.ftChargeItemCases.CatalogueServicesDiscountedVATRate20x0052 => V1.AT.ftChargeItemCases
                            .CatalogueServicesDiscounted2Vat0x0013,
                        V2.ftChargeItemCases.CatalogueServicesSpecialVATRate10x0054 => V1.AT.ftChargeItemCases
                            .CatalogueServicesSpecial1Vat0x0015,
                        V2.ftChargeItemCases.CatalogueServicesZeroVAT0x0057 => V1.AT.ftChargeItemCases
                            .CatalogueServicesZeroVat0x0016,
                        V2.ftChargeItemCases.OwnConsumptionNormalVATRate0x0073 => V1.AT.ftChargeItemCases
                            .OwnConsumptionNormalVat0x0019,
                        V2.ftChargeItemCases.OwnConsumptionDiscountedVATRate10x0071 => V1.AT.ftChargeItemCases
                            .OwnConsumptionDiscounted1Vat0x0017,
                        V2.ftChargeItemCases.OwnConsumptionDiscountedVATRate20x0072 => V1.AT.ftChargeItemCases
                            .OwnConsumptionDiscounted2Vat0x0018,
                        V2.ftChargeItemCases.OwnConsumptionSpecialVATRate10x0074 => V1.AT.ftChargeItemCases
                            .OwnConsumptionSpecial1Vat0x001A,
                        V2.ftChargeItemCases.OwnConsumptionZeroVAT0x0077 => V1.AT.ftChargeItemCases
                            .OwnConsumptionZeroVat0x001B,
                        V2.ftChargeItemCases.AccountOfAThirdParty0x0068 => V1.AT.ftChargeItemCases
                            .AccountOfThirdParty0x0021,
        ...
        public void ConvertftPayItemCaseToV1(PayItem payItem)
        {
            ...
            else
            {
                var v1ftPayItemCase = v2ftPayItemCase switch
                {
                    ...
                    V2.ftPayItemCases.Cash0x0001 => v2PayItem.IsV2PayItemCaseFlagTip0x0040()
                        ? V1.FR.ftPayItemCases.TipToEmployee0x0012
                        : (v2PayItem.IsV2PayItemCaseFlagForeignCurrency0x0010()
                            ? V1.FR.ftPayItemCases.CashForeignCurrency0x0002
                            : V1.FR.ftPayItemCases.Cash0x0001),
        ...
        public void ConvertftReceiptCaseToV1(ReceiptRequest receiptRequest)
        {
            ...
            var v1ftReceiptCase = v2ftReceiptCase switch
            {
                ...
                V2.ftReceiptCases.PointOfSaleReceiptWithoutObligation0x0003 => V1.AT.ftReceiptCases
                ...
                V2.ftReceiptCases.InternalUsageMaterialConsumption0x3003 => V1.AT.ftReceiptCases
                    .InternalUsageMaterialConsumption0x000E,
        ...
        public void ConvertftSignatureFormatToV2(SignaturItem ftSignatureFormat)
        {
            ...
            ftSignatureFormat.ftSignatureFormat = (long)((ulong)v1SignatureFormat.ftSignatureFormat & 0xFFFF);

            ftSignatureFormat.ftSignatureFormat |=
                (long)((V1.AT.ftSignatureFormats)(v1SignatureFormat.ftSignatureFormat & 0xFFFF) switch
                {
        ...
        public void ConvertftSignatureTypeToV2(SignaturItem ftSignatureType)
        {
            ...
            switch (v1SignatureType.ftSignatureType & 0xFFF)
            {
                case (long)V1.AT.ftSignatureTypes.Unknown0x0000:
                    V2SignaturItemftSignatureTypeSignatureTypeExt.SetV2SignatureType(ftSignatureType,
                        (long)V2.ftSignatureTypes.Unknown0x0000);
                    break;
                case (long)V1.AT.ftSignatureTypes.SignatureAccordingToRKSV0x0001:
                    V2SignaturItemftSignatureTypeSignatureTypeExt.SetV2SignatureType(ftSignatureType,
                        (long)V2.AT.ftSignatureTypes.SignatureAccordingToRKSV0x0001);
                    break;
                case (long)V1.AT.ftSignatureTypes.ArchivingRequired0x0002:
                    V2SignaturItemftSignatureTypeSignatureTypeExt.SetV2SignatureType(ftSignatureType,
                        (long)V2.AT.ftSignatureTypes.DailyOperationNotification0x002);
                    break;
                case (long)V1.AT.ftSignatureTypes.FinanzOnlineNotification0x0003:
                    V2SignaturItemftSignatureTypeSignatureTypeExt.SetV2SignatureType(ftSignatureType,
                        (long)V2.AT.ftSignatureTypes.FinanzOnlineNotification0x0003);
                    break;
                default:
                    throw new NotImplementedException();
            }
        ...
        public void ConvertftStateToV2(ReceiptResponse ftstate)
        {
            ...
            if (v1ReceiptResponse.IsV1StateSSCDPermanentlyOutOfService0x0004())
            {
            ...
            if (v1ReceiptResponse.IsV1StateMonthlyReportDue0x0010())
            {
                ftstate.SetV2ftStateFlagMonthlyClosing();
            }

            if (v1ReceiptResponse.IsV1StateAnnualReportDue0x0020())
            {
