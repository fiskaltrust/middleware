...
namespace fiskaltrust.Interface.Tagging.Models
{
    ...
    [CaseExtensions(OnType = typeof(SignaturItem), OnField = nameof(SignaturItem.ftSignatureType), Mask = 0x7FFF_0000_0000_0000, Shift = 12, CaseName = "Country")]
    public enum SignaturItemCountryCodes : long
    {
        AT = 0x4154,
        DE = 0x4445,
        FR = 0x4652,
