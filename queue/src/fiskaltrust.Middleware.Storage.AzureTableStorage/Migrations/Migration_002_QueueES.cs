...
{
    public class Migration_002_QueueES : IAzureTableStorageMigration
    {
        private readonly TableServiceClient _tableServiceClient;
        private readonly QueueConfiguration _queueConfiguration;

        public Migration_002_QueueES(TableServiceClient tableServiceClient, QueueConfiguration queueConfiguration)
        {
