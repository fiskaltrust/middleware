...
public static class FallBackOperations
{
    ...
    public static Task<ProcessCommandResponse> NotYetImplemented(ProcessCommandRequest request) => throw new NotImplementedException($"The ftReceiptCase {request.ReceiptRequest.ftReceiptCase.Case()} - 0x{request.ReceiptRequest.ftReceiptCase.Case():x} is not yet implemented in the QueueBE implementation.");
}