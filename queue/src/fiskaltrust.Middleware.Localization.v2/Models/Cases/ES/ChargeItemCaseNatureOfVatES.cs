...
namespace fiskaltrust.Middleware.Localization.v2.Models.Cases.ES;
...
public static class ChargeItemCaseNatureOfVatESExt
{
    ...
    public static ChargeItemCaseNatureOfVatES NatureOfVatES(this ChargeItemCase self) => (ChargeItemCaseNatureOfVatES) ((long) self & 0xFF00);
}
