...
{
    public class InvoiceUnknown0x1000 : IReceiptTypeProcessor
    {
        private readonly IITSSCDProvider _itSSCDProvider;

        public ITReceiptCases ReceiptCase => ITReceiptCases.InvoiceUnknown0x1000;

        public bool FailureModeAllowed => true;

        public bool GenerateJournalIT => true;

        public InvoiceUnknown0x1000(IITSSCDProvider itSSCDProvider)
        {
