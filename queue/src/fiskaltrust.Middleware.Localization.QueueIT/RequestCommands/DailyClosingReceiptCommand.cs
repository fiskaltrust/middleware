...
namespace fiskaltrust.Middleware.Localization.QueueIT.RequestCommands
{
    ...
    {
        public DailyClosingReceiptCommand(IServiceProvider services) { }
        ...
        public override Task<RequestCommandResponse> ExecuteAsync(IITSSCD client, ftQueue queue, ReceiptRequest request, ftQueueItem queueItem, ftQueueIT queueIt)
        {
            ...
            var actionJournalEntry = CreateActionJournal(queue.ftQueueId, request.ftReceiptCase, queueItem.ftQueueItemId, "Daily-closing receipt was processed.", 
