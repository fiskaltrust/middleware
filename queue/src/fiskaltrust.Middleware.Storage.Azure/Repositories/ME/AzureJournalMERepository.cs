...
{
    public class AzureJournalMERepository : BaseAzureTableRepository<Guid, AzureFtJournalME, ftJournalME>, IJournalMERepository, IMiddlewareRepository<ftJournalME>
    {
