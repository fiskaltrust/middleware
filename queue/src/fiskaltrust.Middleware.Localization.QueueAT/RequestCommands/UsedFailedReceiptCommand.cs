...
{
    internal class UsedFailedReceiptCommand : RequestCommand
    {
        public override string ReceiptName => throw new NotImplementedException();

        public UsedFailedReceiptCommand(IATSSCDProvider sscdProvider, MiddlewareConfiguration middlewareConfiguration, QueueATConfiguration queueATConfiguration, ILogger<RequestCommand> logger)
