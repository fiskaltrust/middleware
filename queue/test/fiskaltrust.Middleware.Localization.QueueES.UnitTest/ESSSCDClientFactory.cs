...
namespace fiskaltrust.CloudCashbox.Clients
{
    public class ESSSCDClientFactory : IClientFactory<IESSSCD>
    {
        ...
        public IESSSCD CreateClient(ClientConfiguration configuration)
        {
            ...
            return configuration.UrlType switch
            {
                ...
                "rest" => HttpESSSCDFactory.CreateSSCDAsync(new HttpESSSCDClientOptions
                {
                ...
                "http" or "https" or "net.tcp" or "wcf" => SoapESSSCDFactory.CreateSSCDAsync(new SoapClientOptions
                {
