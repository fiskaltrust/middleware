...
public class InvoiceCounterMigrationTests
{
    ...
    public async Task UpgradedQueue_SeedsAtLastSubmittedAa()
    {
        ...
        await InvoiceCounterMigration.EnsureMigratedAsync(configRepoMock.Object, queueItemRepository, queue.ftQueueId);
    ...
    public async Task EmptyQueue_SeedsZero()
    {
        ...
        await InvoiceCounterMigration.EnsureMigratedAsync(configRepoMock.Object, QueueItemRepo(), queue.ftQueueId);
