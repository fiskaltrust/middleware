...
public class InvoiceCommandProcessorGRTests
{
    ...
    public async Task InvoiceUnknown0x1000Async_ShouldReturnEmptyList()
    {
        ...
        var invoiceCommandProcessor = new InvoiceCommandProcessorGR(grSSCDMock.Object, queueStorageProviderMock.Object, TestHelpers.CreateConfigurationRepositoryStub(), TestHelpers.CreateQueueItemRepositoryStub());
    ...
    public async Task InvoiceUnknown0x1000Async_RefundFlag_WithReferencedRefund_ShouldLoadQueueItem_ShouldReturnEmptyList()
    {
        ...
        var invoiceCommandProcessor = new InvoiceCommandProcessorGR(grSSCDMock.Object, queueStorageProvider, TestHelpers.CreateConfigurationRepositoryStub(), TestHelpers.CreateQueueItemRepositoryStub());
        var result = await invoiceCommandProcessor.InvoiceUnknown0x1000Async(new ProcessCommandRequest(queue, receiptRequest, receiptResponse));
