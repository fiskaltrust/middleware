...
namespace fiskaltrust.Middleware.Localization.QueueGR.UnitTest
{
            ...
            var initOperationReceipt = $$"""
 {
     ...
     "cbChargeItems": [],
     "cbPayItems": [],
     "ftReceiptCase": {{0x4752200000000000 | (long) ReceiptCases.InitialOperationReceipt0x4001}},
     "ftReceiptCaseData": "",
     "cbUser": "Admin"
 }
 """;
            ...
            receiptResponse.ftState.Should().Be(0x4752_2000_EEEE_EEEE, because: $"ftState {receiptResponse.ftState.ToString("X")} is different than expected.");
        }
            ...
            var initOperationReceipt = $$"""
 {
     ...
     "cbChargeItems": [],
     "cbPayItems": [],
     "ftReceiptCase": {{0x4752200000000000 | (long) receiptCase}},
     "ftReceiptCaseData": "",
     "cbUser": "Admin"
 }
 """;
            ...
            receiptResponse.ftState.Should().Be(0x4752_2000_0000_0001, because: $"ftState {receiptResponse.ftState.ToString("X")} is different than expected.");
