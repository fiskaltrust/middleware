...
namespace fiskaltrust.Middleware.Storage.Azure.AcceptanceTest
{
    public class AzureOpenTransactionRepositoryTests : AbstractOpenTransactionRepositoryTests
    {
        ...
        {
            var azureReceiptJournalRepository = new AzureOpenTransactionRepository(new QueueConfiguration { QueueId = Guid.NewGuid() }, new TableServiceClient(Constants.AzureStorageConnectionString));
