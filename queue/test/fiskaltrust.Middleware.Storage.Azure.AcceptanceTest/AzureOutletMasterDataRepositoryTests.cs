...
namespace fiskaltrust.Middleware.Storage.Azure.AcceptanceTest
{
    public class AzureOutletMasterDataRepositoryTests : AbstractOutletMasterDataRepositoryTests
    {
        ...
        {
            var repository = new AzureOutletMasterDataRepository(new QueueConfiguration { QueueId = Guid.NewGuid() }, new TableServiceClient(Constants.AzureStorageConnectionString));
