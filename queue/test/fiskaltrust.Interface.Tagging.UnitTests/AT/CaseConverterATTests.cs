...
namespace fiskaltrust.Interface.Tagging.UnitTests.AT
{
    public class CaseConverterATTests
    {
        ...
        [InlineData(0x4154200080010002, 0x415480000001000C)]
        ...
        [InlineData(0x4154200000004011, null)]
        [InlineData(0x4154200000004012, null)]
        ...
        [InlineData(0x4154200080000003, 0x4154800000000007)]
        ...
        [InlineData(0x4154200000003004, null)]
