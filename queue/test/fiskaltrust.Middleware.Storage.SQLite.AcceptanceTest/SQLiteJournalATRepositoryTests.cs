...
{
    public class SQLiteJournalATRepositoryTests : AbstractJournalATRepositoryTests
    {
        ...
        private SQLiteJournalATRepository _repo;
        ...
        public override async Task<IJournalATRepository> CreateRepository(IEnumerable<ftJournalAT> entries)
        {
            ...
            _repo = new SQLiteJournalATRepository(_sqliteConnectionFactory, _path);
