...
namespace fiskaltrust.Middleware.Storage.EF.AcceptanceTest
{
    ...
    public class EfJournalDERepositoryTests : AbstractJournalDERepositoryTests
    {
        ...
        public override async Task<IMiddlewareJournalDERepository> CreateRepository(IEnumerable<ftJournalDE> entries)
        {
            ...
            var repository = new EfJournalDERepository(new MiddlewareDbContext(EfConnectionStringFixture.DatabaseConnectionString, queueId, 60));
