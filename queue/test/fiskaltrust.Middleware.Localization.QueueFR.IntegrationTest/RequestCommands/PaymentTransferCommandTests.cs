...
{
    public class PaymentTransferCommandTests : IClassFixture<SignProcessorDependenciesFixture>
    {
        private readonly SignProcessorDependenciesFixture _fixture;
        public PaymentTransferCommandTests(SignProcessorDependenciesFixture fixture) => _fixture = fixture;
        ...
        public async Task ExecuteAsync_ShouldCreateTrainingReceiptResponse_WhenRequestHasTrainingReceiptFlag()
        {
            ...
            var command = new PaymentTransferCommand(_fixture.signatureFactoryFR);
        ...
        public void Validate_ShouldReturnValidationError_WhenRequestDoesNotHaveValidPayItems()
        {
            ...
            Assert.Equal("The Payment Transfer receipt must not have charge items.", result.First().Message);
        }
    }
}
