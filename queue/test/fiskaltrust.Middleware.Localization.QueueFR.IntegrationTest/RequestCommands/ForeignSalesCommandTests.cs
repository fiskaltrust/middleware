...
{
    public class ForeignSalesCommandTests : IClassFixture<SignProcessorDependenciesFixture>
    {
        private readonly SignProcessorDependenciesFixture _fixture;
        public ForeignSalesCommandTests(SignProcessorDependenciesFixture fixture) => _fixture = fixture;
        ...
        public async Task ExecuteAsync_ShouldCreateTrainingReceiptResponse_WhenRequestHasTrainingReceiptFlag()
        {
            ...
            var command = new ForeignSalesCommand(_fixture.signatureFactoryFR);
        ...
        public void Validate_ShouldReturnValidationError_WhenRequestDoesNotHaveValidPayItems()
        {
            ...
            Assert.Equal("The Foreign Sale receipt must have one pay item with the ftPayItemCase = 0x4652000000000011.", result.First().Message);
        }
    }
}
