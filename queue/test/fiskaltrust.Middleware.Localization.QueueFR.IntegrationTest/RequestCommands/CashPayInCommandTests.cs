...
{
    public class CashPayInCommandTests : IClassFixture<SignProcessorDependenciesFixture>
    {
        private readonly SignProcessorDependenciesFixture _fixture;
        public CashPayInCommandTests(SignProcessorDependenciesFixture fixture) => _fixture = fixture;
        ...
        public async Task ExecuteAsync_ShouldCreateTrainingReceiptResponse_WhenRequestHasTrainingReceiptFlag()
        {
            ...
            var command = new CashPayInCommand(_fixture.signatureFactoryFR);
        ...
        public void Validate_ShouldReturnValidationError_WhenRequestDoesNotHaveValidPayItems()
        {
            ...
            Assert.Equal("The Cash Deposit receipt must not have charge items.", result.First().Message);
        }
    }
}
