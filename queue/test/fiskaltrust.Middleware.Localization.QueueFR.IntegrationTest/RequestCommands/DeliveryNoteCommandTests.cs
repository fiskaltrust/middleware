...
{
    public class DeliveryNoteCommandTests : IClassFixture<SignProcessorDependenciesFixture>
    {
        private readonly SignProcessorDependenciesFixture _fixture;
        public DeliveryNoteCommandTests(SignProcessorDependenciesFixture fixture) => _fixture = fixture;
        ...
        public async Task ExecuteAsync_ShouldCreateTrainingReceiptResponse_WhenRequestHasTrainingReceiptFlag()
        {
            ...
            var command = new DeliveryNoteCommand(_fixture.signatureFactoryFR);
