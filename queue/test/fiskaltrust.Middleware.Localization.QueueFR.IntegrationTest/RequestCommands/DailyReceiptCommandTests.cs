...
{
    public class DailyReceiptCommandTests : IClassFixture<SignProcessorDependenciesFixture>
    {
        private readonly SignProcessorDependenciesFixture _fixture;
        public DailyReceiptCommandTests(SignProcessorDependenciesFixture fixture) => _fixture = fixture;
        ...
        public async Task ExecuteAsync_ShouldCreateTrainingReceiptResponse_WhenRequestHasTrainingReceiptFlag()
        {
            ...
            var command = new DailyReceiptCommand(_fixture.signatureFactoryFR);
        ...
        public async Task ExecuteAsync_ShouldCreateDefaultReceiptResponse_WhenRequestDoesNotHaveTrainingReceiptFlag()
        {
            ...
            actionJournals.Should().Contain(x => x.Message == "Daily closure");
        ...
        public void Validate_ShouldReturnValidationError_WhenRequestDoesNotHaveValidPayItems()
        {
            ...
            result.ToList().Should().Contain(x => x.Message == "The Daily receipt must not have charge items.");
            result.ToList().Should().Contain(x => x.Message == "The Daily receipt must not have pay items.");
        }
    }
}
