...
//     public class EFCoreSQLServerAgencyMasterDataRepositoryTests : AbstractAgencyMasterDataRepositoryTests
//     {
//         public override IMasterDataRepository<AgencyMasterData> CreateReadOnlyRepository(IEnumerable<AgencyMasterData> entries) => CreateRepository(entries);

//         public override IMasterDataRepository<AgencyMasterData> CreateRepository(IEnumerable<AgencyMasterData> entries)
//         {
...
//             var repository = new EFCoreAgencyMasterDataRepository(new SQLServerMiddlewareDbContext(optionsBuilder.Options, queueId));
