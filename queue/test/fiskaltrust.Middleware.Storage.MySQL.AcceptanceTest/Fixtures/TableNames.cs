namespace fiskaltrust.Middleware.Storage.MySQL.AcceptanceTest.Fixtures
{
    public static class TableNames
    {
        ...
        public static string FtCashBox = "ftCashBox";
        ...
        public static string OpenTransaction = "OpenTransaction";
        public static string AccountMasterData = "AccountMasterData";
        public static string OutletMasterData = "OutletMasterData";
        public static string AgencyMasterData = "AgencyMasterData";
        public static string PosSystemMasterData = "PosSystemMasterData";
    }
}
