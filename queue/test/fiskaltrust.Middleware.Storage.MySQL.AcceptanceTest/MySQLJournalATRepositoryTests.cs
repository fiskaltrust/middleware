...
namespace fiskaltrust.Middleware.Storage.MySQL.AcceptanceTest
{
    ...
    public class MySQLJournalATRepositoryTests : AbstractJournalATRepositoryTests
    {
        private MySQLJournalATRepository _repo;
        ...
        public override async Task<IJournalATRepository> CreateRepository(IEnumerable<ftJournalAT> entries)
        {
            ...
            _repo = new MySQLJournalATRepository(MySQLConnectionStringFixture.DatabaseConnectionString);
