...
namespace fiskaltrust.Middleware.Localization.QueueIT.UnitTest
{
    public class PosReceiptCommandTest
    {
        ...
        public async Task ExecuteAsync_RegisterInvoice_ValidResultAsync()
        {
            ...
            var posReceiptCommand = new PosReceiptCommand(desscdMock.Object, new SignatureItemFactoryIT(), Mock.Of<IMiddlewareJournalITRepository>(), configRepoMock.Object, Mock.Of<ILogger<RequestCommand>>());
