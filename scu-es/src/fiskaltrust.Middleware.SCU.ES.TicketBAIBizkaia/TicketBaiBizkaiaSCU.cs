...
{
    public TicketBaiBizkaiaSCU(ILogger<TicketBaiSCU> logger, TicketBaiSCUConfiguration configuration) : base(logger, configuration, new TicketBaiBizkaiaTerritory())
    {
    }
}