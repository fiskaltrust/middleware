using fiskaltrust.service.launcher.Helpers.Grpc.Binders;
using fiskaltrust.service.launcher.Helpers.Grpc.Interceptors;
using Grpc.Core;
...
namespace fiskaltrust.service.launcher.Helpers.Grpc
{
    public static class GrpcHelper
    {
        ...
        public static int AddCodeFirst(this Server.ServiceDefinitionCollection services, Type type, object service, BinderConfiguration binderConfiguration = null, TextWriter log = null, IEnumerable<Interceptor> interceptors = null)
        {
            ...
            int result = Binder.Create(log).Bind(builder, type, binderConfiguration, service);
