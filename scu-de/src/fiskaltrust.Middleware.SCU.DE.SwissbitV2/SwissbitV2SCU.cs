...
using fiskaltrust.Middleware.SCU.DE.SwissbitV2.Exceptions;
using fiskaltrust.Middleware.SCU.DE.SwissbitV2.Helpers;
using fiskaltrust.Middleware.SCU.DE.SwissbitV2.Interop;
using fiskaltrust.Middleware.SCU.DE.SwissbitV2.Models;
using Microsoft.Extensions.Logging;
using Newtonsoft.Json;
using static fiskaltrust.Middleware.SCU.DE.SwissbitV2.Interop.NativeFunctionPointer;


namespace fiskaltrust.Middleware.SCU.DE.SwissbitV2
{
    public sealed class SwissbitV2SCU : IDESSCD, IDisposable
    {
        ...
        private readonly SwissbitV2SCUConfiguration _configuration;
        private readonly INativeFunctionPointerFactory _nativeFunctionPointerFactory;
        private readonly ILogger<SwissbitV2SCU> _logger;
        ...
        public SwissbitV2SCU(SwissbitV2SCUConfiguration configuration, INativeFunctionPointerFactory nativeFunctionPointerFactory, ILogger<SwissbitV2SCU> logger, LockingHelper lockingHelper)
        {
