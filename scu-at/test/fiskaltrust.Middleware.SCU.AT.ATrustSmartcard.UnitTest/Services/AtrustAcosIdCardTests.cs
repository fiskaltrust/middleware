...
{
    public class AtrustAcosIdCardTests
    {
        ...
        public AtrustAcosIdCardTests()
        {
            ...
            _sut = new AtrustAcosID(_scardReader.Object, _isoReader.Object);
        ...
        public void checkApplication_ShouldReturnTrue_IfResponceIsCorrect()
        {
            ...
            _sut.CheckApplication().Should().BeTrue();
        }
